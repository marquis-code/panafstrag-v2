<template>
  <div class="relative isolate bg-gray-900 mt-10">
      ...
      >
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-300">
            ...
            us anytime through our Contact Page or use our live chat for quick
            responses. Let's connect!
          </p>
          <dl class="mt-10 space-y-4 text-base leading-7 text-gray-300">
            <div class="flex gap-x-4">
              ...
              <dd>302, Iju Road; Iju-Ishaga bus stop, Lagos, Nigeria</dd>
            </div>
            <div class="flex gap-x-4">
              <dt class="flex-none">
              ...
              <dd>
                <a class="hover:text-white" href="https://wa.me/2348055177436"
                  >+234-8055177436</a
                >
              </dd>
              <dd>
                <a class="hover:text-white" href="https://wa.me/2348056210960"
                  >+234-8056210960</a
                >
              </dd>
            </div>
        ...
        <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            ...
            <div class="sm:col-span-2">
              ...
              <div class="mt-2.5">
                <textarea
                  ...
                  id="message"
                  rows="4"
                  class="block w-full resize-none rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"
                ></textarea>
              </div>
            </div>
          </div>
          <div class="mt-8 flex justify-end">
            <button
              ...
              type="submit"
              class="rounded-md disabled:cursor-not-allowed disabled:opacity-25 bg-indigo-500 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
            >
