    ...
    <div class="relative isolate overflow-hidden pt-14">
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <ssr-carousel loop :autoplay-delay="3">
          <div
            class="text-center px-3 md:px-0"
            v-for="(itm, idx) in carousels"
            :key="idx"
          >
            <h1
              class="text-2xl md:text-4xl font-bold tracking-tight text-white sm:text-6xl"
            >
              {{ itm.title }}
            </h1>
            <p class="mt-6 md:text-lg leading-8 text-gray-300">
              {{ itm.description }}
            </p>
