    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:mx-0">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-300">
          Outlined below are our goals at PANAFSTRAG
        </p>
      </div>
          ...
          <!-- <div class="flex flex-col">
            ...
            >
              <p class="flex-auto">
                ...
                natus. Earum nihil deserunt eos quasi cupiditate. A inventore et
                molestiae natus.
              </p>
              <p class="mt-6">
                <a
          ...
          <div class="flex flex-col">
            ...
            >
              <p class="flex-auto">
                ...
                Ex adipisci et doloremque autem quia quam. Quis eos molestiae at
                iure impedit.
              </p>
              <p class="mt-6">
                <a
